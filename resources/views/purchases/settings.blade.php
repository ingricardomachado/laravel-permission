...
<div class="card">
  ...
  <div class="card-body">
      ...
      <div class="col-12 text-right">
        ...
        <a href="{{ url('purchases') }}" class="btn btn-sm btn-default" title=""><i class="fa fa-hand-o-left" aria-hidden="true"></i> Regresar</a>        
      </div>
  </div>
</div>
...
function update_settings(){
    ...
    if(formulario_validado){
      ...
      $.ajax({
        url:'{{URL::to("purchases.update_settings")}}/'+id,
        type:'POST',
        cache:true,
        processData: false,
        contentType: false,      
