...
<div class="container lst">
    ...
    <form action="{{url('customers/'.$customer->id)}}" id="form_customer" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                    ...
                    @if(!$customer->id)
                        <div class="form-group col-sm-12">
                            <b>CONTACTO PRINCIPAL</b><small> Una vez registrado el cliente podrá registrar más contactos.</small>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>Nombre *</label>
