...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">
    <i class="fa fa-users" aria-hidden="true"></i> Suscriptores demo</h3>
  </div>
  <div class="card-body">
    <div class="col-sm-12 col-xs-12 text-right">
        <a href="#" class="btn btn-sm btn-primary" onclick="showModalSubscriber(0);"><i class="fa fa-plus-circle"></i> Nuevo Suscriptor</a>
      <a href="{{ url('subscribers.rpt_subscribers', 1) }}" class="btn btn-sm btn-default" target="_blank" title="Imprimir PDF"><i class="fa fa-print"></i></a><br><br>
    </div>
